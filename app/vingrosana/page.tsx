...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.fiziokaspars.lv/vingrosana",
  },
  openGraph: {
      ...
      >
        ...
        <div className="mt-8 flex max-w-3xl flex-col gap-3">
          ...
          <p>
            ...
            operācijas. Sāksim ar to, ka{" "}
            <b>nav veselu cilvēku ar ideālu stāju</b>. Tas saistīts ar to, ka
            jebkuram cilvēkam viena ir dominējošā roka vai kāja viņa ikdienas
            aktivitātēs - nav svarīgi, vai tas ir profesionāls basketbolists,
            ofisa darbinieks vai pensionārs, kas izbauda sev sarūpēto atpūtu.
            Kaut vai tas, kā mēs sēžam - gribās atbalstīt vienu elkoni vairāk kā
            otru. Kaut vai tas, ka pulksteni nēsājam visbiežāk uz kreisās rokas.
            Kaut vai tas, ka telefonu nēsājam līdzi pārsvarā vienā un tai pašā
            kabatā. Jo vairāk šādu asimetrisku darbību, jo vairāk ir jādomā par
            ārstniecisko vingrošanu muskuļu balansa saglabāšanai.
          </p>
          <p>
          ...
          <p>
            ...
            mugurā <b>ir problēmas sekas</b>. Problēmas cēlonis (tālbraucēja
            gadījumā) ir muskuļu disbalanss. Tāpēc vajag vingrot, lai atgūtu
            vienādu muskuļu spēku starp labo un kreiso ķermeņa pusi, atgūtu
            pareizas spēku proporcijas apkārt locītavām. Jo cietās struktūras
            (kauli, locītavas) tiks vilktas spēcīgākā muskuļa virzienā. Muskuļu
