  ...
  return (
    <div className="w-full">
      <div className="relative mx-auto flex h-[50px] w-full flex-col items-center rounded-sm bg-gradient-to-b from-red-400 to-cyan-500 bg-cover sm:h-[173px] md:h-[261px] lg:h-[410px]">
        {/* <div className="border-1 md:shadow-x absolute flex h-[205px] w-[350px] items-center justify-center overflow-hidden rounded-lg border-white/20 bg-[linear-gradient(to_bottom,rgba(0,0,0,0),rgba(0,0,0,0.4)),url('/hero.png')] from-blue-400 to-transparent bg-cover bg-no-repeat sm:h-[323px] sm:w-[550px] md:h-[411px] md:w-[700px] lg:h-[558px] lg:w-[950px]">
          <BorderBeam
            borderWidth={3}
            size={350}
            duration={12}
